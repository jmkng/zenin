export default function MenuIcon() {
    return <svg className="zenin__icon zenin__menu_icon" width="100%" height="100%" viewBox="0 0 24 24" version="1.1" xmlns="http://www.w3.org/2000/svg" style={{ fillRule: "evenodd", clipRule: "evenodd", strokeLinejoin: "round", strokeMiterlimit: 2 }}>
            ...
            <g transform="matrix(0.333333,0,0,0.333333,1.33333,1.33333)">
                <path d="M48,32C48,33.105 47.105,34 46,34L4,34C2.895,34 2,33.105 2,32C2,30.895 2.895,30 4,30L46,30C47.105,30 48,30.895 48,32Z" style={{ fillRule: "nonzero", stroke: "currentcolor", strokeWidth: 2 }} />
            </g>
