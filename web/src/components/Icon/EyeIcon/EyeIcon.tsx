...
export default function EyeIcon(props: EyeIconProps) {
    ...
    return (
        <svg className="zenin__icon zenin__eye_icon" width="100%" height="100%" viewBox="0 0 24 24" version="1.1" xmlns="http://www.w3.org/2000/svg" style={{ fillRule: "evenodd", clipRule: "evenodd", strokeLinejoin: "round", strokeMiterlimit: 2 }}>
